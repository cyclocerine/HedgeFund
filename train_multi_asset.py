...
SP500_TICKERS = [
    ...
    "DHR", "VZ", "ADBE", "CRM", "NKE", "CMCSA", "TXN", "NEE", "PM", "WFC",
    "BMY", "RTX", "UPS", "QCOM", "HON", "ORCL", "INTC", "IBM", "AMD", "CAT",
    "LOW", "SPGI", "GS", "BA", "SBUX", "BLK", "AXP", "DE", "GILD", "MS",
    "MDLZ", "ADI", "ISRG", "AMT", "CVS", "PLD", "BKNG", "LMT", "T", "SYK",
    "MMC", "VRTX", "CB", "CI", "TJX", "ADP", "NOW", "SCHW", "MO", "SO",
    "EOG", "DUK", "CL", "ZTS", "REGN", "SLB", "BDX", "ITW", "BSX", "PNC",
    "CME", "NOC", "APD", "FDX", "ICE", "MU", "USB", "CCI", "LRCX", "GD"
]
...
def prepare_sequences_multi_feature(data_dict, lookback=60):
...
def run_training(epochs=50, batch_size=64, lr=1e-3, lookback=60, selected_indices=None):
